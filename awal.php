  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner py-3">
      <div class="carousel-item active">
        <img src="assetsProduk/Promo1.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="assetsProduk/Promo2.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
    ...
    <div class="row">
      <div class="card col-">
        ...
        <div class="container text" style="width: 18rem;">
          <img src="assetsProduk/produk pc.jpg" class="card-img-top" alt="..."
            style="margin-top: 30px; width: 200px; height: auto;">
          <div class="card-body">
            <h5 class="card-title" style="margin-top: 30px;">PC ROG RTX 4090 TI</h5>
            ...
            <a href="Product.html" class="btn btn-primary" style="margin-top: 39px;">Pergi ke Produk</a>
          </div>
        </div>
      </div>
      <div class="card col-">
